...
namespace NativeZip
{
	internal static class Base
	{
		...
		public struct State
		{
			...
			{
				Index -= (byte)(Index < 4 ? Index : (Index < 10 ? 3 : 6));
			}
			public void UpdateMatch() { Index = (byte)(IsCharState ? 7 : 10); }
			public void UpdateRep() { Index = (byte)(IsCharState ? 8 : 11); }
			public void UpdateShortRep() { Index = (byte)(IsCharState ? 9 : 11); }
